...
<div class="form-container">
	...
	<form class="form">
		<div class="input-group">
			...
			<input type="text"  placeholder="" v-model="Acc.firstName">
		</div>
        <div class="input-group">
			<label for="username">LastName</label>
			<input type="text"  placeholder="" v-model="Acc.lastName">
		</div>
		<div class="input-group">
			<label for="username">NickName</label>
			<input type="text" placeholder="" v-model="Acc.nickName">
			<br><br>
		</div>
		<div class="input-group">
			<label for="password">Password</label>
			<input type="password"  placeholder="" v-model="Acc.password">
			<br><br>
		</div>
